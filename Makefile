HEADERS       := calendar.h
IMPLEMS       := calendar.cpp
OUT           := calendar
TEST          := calendar_test.cpp
TEST_OUT      := calendar_test
DRIVER        := main.cpp
...
test: $(TEST) $(IMPLEMS) $(HEADERS)
	@echo "\n========================\nRunning tests\n========================\n"
	@g++ -std=c++17 $(TEST) $(IMPLEMS) $(GTEST)/libgtest.a $(GTEST)/libgtest_main.a -isystem $(GTEST)/include -pthread -o $(TEST_OUT)
	@./$(TEST_OUT)
	@echo "\n========================\nTests complete\n========================\n"
